  ...
  $(function(){
    ...
    $.fn.makeTable = function(options){
      var opts = {
        ...
        "sDom": "<'row'<'col-sm-6'l><'col-sm-6'f>r><'row dt-table'<'col-md-12't>><'row dt-info'<'col-sm-6'i><'col-sm-6'p>>",
        "columns": [
            { data: 'marker' },
            { data: 'name' },
            { data: 'size', className: 'right aligned'},
            { data: 'publish' , className: 'mark'}
        ]
      };
      ...
      opts.ajax.url = durl;
      opts.ajax.beforeSend = function(){};
      opts.ajax.complete = function(){};

      return self.DataTable(opts);
    };
